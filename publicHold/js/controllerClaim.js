...
//        $scope.currentDaily.EXPENSE_TYPE_ID = null;
        rowLen= $scope.daily.push({DAILY_DETAIL_ID: 'new',DAILY_ID_: 0, WORK_DATE: $scope.form.SET_WORK_DATEDEFSHORT, WORK_TIME: '.10', WORK_DESCRIPTION: 'Work Description pending.', MILEAGE: '0', EXPENSE: 0,CLAIM_NO:  $scope.CLAIM_NO  ,AR_ID:"null"});
        console.log('rowLen ',rowLen);
   // rowLen= $scope.daily.push({DAILY_DETAIL_ID: 'new',DAILY_ID_: 0, WORK_DATE: $scope.form.SET_WORK_DATEDEFSHORT, WORK_TIME: '.10', WORK_DESCRIPTION: 'Work Description pending.', MILEAGE: '0', EXPENSE: 0,CLAIM_NO:  $scope.CLAIM_NO $scope.CLAIM_NO$scope.currentClaimNo ,AR_ID:"null"});
